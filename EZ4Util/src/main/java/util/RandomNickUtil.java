...
public class RandomNickUtil {
     ...
     * 随机昵称 形容词
     */
    public static String[] FIRST_NAME = {"迷你的", "鲜艳的", "飞快的", "真实的", "清新的", "幸福的", "可耐的", "快乐的", "冷静的", "醉熏的", "糊涂的", "积极的", "冷酷的", "深情的", "粗暴的",
            ...
            "饱满的", "炙热的", "青春无敌的", "碧蓝的", "俊逸的", "英勇的", "健忘的", "故意的", "无心的", "土豪的", "朴实的", "兴奋的", "幸福的", "淡定的", "不安的", "阔达的", "孤独的",
            ...
            "凶狠的", "害怕的", "重要的", "谈吐大方的", "欢喜的", "欣慰的", "满意的", "跳跃的", "诚心的", "称心的", "如意的", "怡然的", "娇气的", "无奈的", "无语的", "激动的", "愤怒的",
     ...
     * 名词
     */
    public static String[] SECOND_NAME = {"嚓茶", "皮皮虾", "皮卡丘", "马里奥", "小霸王", "凉面", "便当", "毛豆", "花生", "可乐", "灯泡", "哈密瓜", "野狼", "背包", "眼神", "缘分", "雪碧", "人生", "牛排",
            ...
            "苗条", "铅笔", "钢笔", "硬币", "热狗", "大侠", "御姐", "萝莉", "毛巾", "期待", "盼望", "白昼", "黑夜", "大门", "黑裤", "钢铁侠", "哑铃", "板凳", "枫叶", "荷花",
            "仙人掌", "衬衫", "大神", "草丛", "早晨", "心情", "茉莉", "流沙", "蜗牛", "战斗机", "冥王星", "猎豹", "棒球", "篮球", "乐曲", "电话", "网络", "世界",  "鱼", "鸡", "狗",
    ...
    public static String getRandomNickname() {
        int firstIndex = new Random().nextInt(FIRST_NAME.length - 1);
        int secondIndex = new Random().nextInt(SECOND_NAME.length - 1);
        return FIRST_NAME[firstIndex].trim() + SECOND_NAME[secondIndex].trim()+new Random().nextInt(1000);
    }
